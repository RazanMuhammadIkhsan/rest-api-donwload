...
import { jsToCoffee, jsToCoffeeEsm } from "./lib/jsToCoffee.js";
...
const tools = {
  ...
  ssweb: async (url) => {
   try {
     const { data } = await axios.get(`https://api.pikwy.com/?tkn=125&d=3000&u=${encodeURIComponent(url)}&fs=0&w=1280&h=1200&s=100&z=100&f=jpg&rt=jweb`)
     return data;
   } catch (e) {
